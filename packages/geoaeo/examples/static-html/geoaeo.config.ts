  ...
  faq: [
    {
      ...
      answer: "Yes. Data refreshes every 15 minutes from national weather services.",
    },
    {
      question: "Which locations are supported?",
      answer: "Every populated place on Earth — over 3 million locations.",
    },
    {
      question: "Do you offer an API?",
      answer: "Yes, on the Enterprise plan. See the pricing page for details.",
    },
  ],
