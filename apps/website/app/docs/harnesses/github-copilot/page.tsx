    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-3xl px-5 py-10 sm:py-14">
        <nav aria-label="Breadcrumb" className="mb-6 text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <Link href="/docs/harnesses/github-copilot" className="hover:text-foreground transition-colors">
            Harnesses
          </Link>
          <span className="mx-2">/</span>
        ...
        <h1 className="text-3xl font-bold tracking-tight">geoaeo for GitHub Copilot</h1>
        <p className="mt-3 text-muted-foreground leading-relaxed">
          Connect the geoaeo MCP server to GitHub Copilot in VS Code. Audit a site and generate GEO and AEO artifacts
          from Copilot Chat and agent mode.
        </p>
