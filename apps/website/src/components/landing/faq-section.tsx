...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "geoaeo audits any site from 0 to 100 across 25 weighted checks, then generates missing discovery artifacts. It outputs llms.txt, llms-full.txt, sitemaps, robots.txt, JSON-LD schemas, WebMCP manifests, and Markdown mirrors. It also includes an AI copy humanizer and an MCP server.",
  },
  {
    ...
    <div className="border-b border-border last:border-b-0">
      ...
      >
        <div className="overflow-hidden">
          <p className="pb-5 text-sm text-muted-foreground leading-relaxed pr-8">{answer}</p>
        </div>
      </div>
    </div>
  );
